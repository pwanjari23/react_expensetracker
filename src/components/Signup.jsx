        ...
        <header className={`border-b sticky top-0 z-50 transition-colors duration-300 ${
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Theme Controls & Premium Actions */}
              <button
                type="button"
                onClick={() => {
                  if (isPremium) {
                    ...
                    alert("🏆 Premium Feature! Exceed Rs 10,000 in expenses and click 'Activate Premium' to unlock custom Light/Dark themes.");
                  }
                }}
                ...
                title={isPremium ? "Toggle Light/Dark Theme" : "Unlock Premium to Toggle Themes"}
              >
                {isDark ? (
                  <>
                  ...
                  <>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-3.5 h-3.5 text-indigo-650">
